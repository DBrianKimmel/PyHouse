"""
@name: PyHouse/src/housing/test/test_houses.py
...
class Test_01_XML(unittest.TestCase):
    """
    This section will verify the XML in the 'src.text.xml_data' file is correct and what the houses module can read/write.
    """
