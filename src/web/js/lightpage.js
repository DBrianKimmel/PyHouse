...
function createNewLightWindow(p_name) {    
	var divId = createNewWindow(p_name, 300, 250, 200, 250);  // width, height, start x, start y
...
function createChangeLightWindow(p_name, p_json) {    
	var divId = createNewWindow(p_name, 250, 120, 200, 250);  // width, height, start x, start y
