    ...
    def read_device(self, p_usb):
        ...
        try:
            ...
            if l_len > 0:
                ...
                print("Driver_USB_0403_6001.read_device() C - len was 0  {0:}".format(l_msg))
        except usb.USBError as e:
            print("Driver_USB_0403_6001.read_device() got USBError {0:}".format(e))
            l_len = 0
            # break
        except Exception as e:
            print(" -- Error in Driver_USB_0403_6001.read_device() {0:}".format(e))
            l_len = 0
            # break
