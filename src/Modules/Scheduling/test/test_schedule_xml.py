...
class C01_XML(SetupMixin, unittest.TestCase):
    ...
    def test_04_ReadOneSchedule(self):
    ...
    def test_05_ReadAllSchedules(self):
        ...
        self.assertEqual(len(l_schedules), 7)

    def test_06_WriteOneBase(self):
