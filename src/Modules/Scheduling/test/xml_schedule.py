...
TESTING_SCHEDULE_TYPE_0 = 'LightingDevice'
TESTING_SCHEDULE_MODE_0 = 'Home'
TESTING_SCHEDULE_DOW_0 = '127'

L_SCHEDULE_START_0 = '<Schedule Name="' + TESTING_SCHEDULE_NAME_0 + '" Key="' + TESTING_SCHEDULE_KEY_0 + '" Active="' + TESTING_SCHEDULE_ACTIVE_0 + '">'
...
L_SCHEDULE_MODE_0 = '<Mode>' + TESTING_SCHEDULE_MODE_0 + '</Mode>'
...
L_SCHEDULE_START_1 = '<Schedule Name="' + TESTING_SCHEDULE_NAME_1 + '" Key="' + TESTING_SCHEDULE_KEY_1 + '" Active="' + TESTING_SCHEDULE_ACTIVE_1 + '">'
...
L_SCHEDULE_MODE_1 = '<Mode>' + TESTING_SCHEDULE_MODE_1 + '</Mode>'
...
L_SCHEDULE_START_2 = '<Schedule Name="' + TESTING_SCHEDULE_NAME_2 + '" Key="' + TESTING_SCHEDULE_KEY_2 + '" Active="' + TESTING_SCHEDULE_ACTIVE_2 + '">'
...
L_SCHEDULE_MODE_2 = '<Mode>' + TESTING_SCHEDULE_MODE_2 + '</Mode>'
...
L_SCHEDULE_START_3 = '<Schedule Name="' + TESTING_SCHEDULE_NAME_3 + '" Key="' + TESTING_SCHEDULE_KEY_3 + '" Active="' + TESTING_SCHEDULE_ACTIVE_3 + '">'
...
L_SCHEDULE_MODE_3 = '<Mode>' + TESTING_SCHEDULE_MODE_3 + '</Mode>'
