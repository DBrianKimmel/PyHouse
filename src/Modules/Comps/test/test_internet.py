...
# Import PyMh files
from Modules.Core.data_objects import PyHouseData, InternetConnectionData, InternetConnectionDynDnsData
...
class Test_02_XML(SetupMixin, unittest.TestCase):
    ...
    def test_0202_find_xml(self):
        ...
        PrettyPrintAny(self.m_inter_sectn_xml, 'All Internet Section', 120)
    ...
    def test_0214_RedAllInternet(self):
        l_obj = self.m_api.read_internet_xml(self.m_inter_sectn_xml)
    ...
    def test_0224_WriteAllInternetXml(self):
        """ Write out the XML file for the location section
        """
        l_internet = self.m_api.read_internet_xml(self.m_inter_sectn_xml)
