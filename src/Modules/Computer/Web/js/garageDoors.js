...
helpers.Widget.subclass(garageDoors, 'GarageDoorsWidget').methods(
		...
		// ============================================================================
		/**
		 * Get all interface info from the server. This data can never change
		 * during a server run.
		 */
		...
		// ============================================================================
		/**
		 * Build a screen full of buttons - One for each controller and some
		 * actions.
		 */
		...
		function buildControllerEntry(self, p_obj, p_html) {
			p_html += buildLcarFamilySelectWidget(self, 'DeviceFamily',
					'Family', p_obj.DeviceFamily, 'familyChanged');
			p_html += buildLcarInterfaceTypeSelectWidget(self, 'InterfaceType',
					'Interface Type', p_obj.InterfaceType, 'interfaceChanged');
		...
		// ============================================================================
		/**
		 * Event handler for submit buttons at bottom of entry portion of this
		 * widget. Get the possibly changed data and send it to the server.
		 */
