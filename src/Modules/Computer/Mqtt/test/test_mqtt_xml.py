...
Passed all 7 tests - DBK - 2015-09-12
...
from Modules.Computer.Mqtt.test.xml_mqtt import \
    ...
    TESTING_BROKER_PORT_1, TESTING_BROKER_USERNAME, TESTING_BROKER_PASSWORD
...
class B1_Read(SetupMixin, unittest.TestCase):
    ...
    def test_01_Broker(self):
        ...
        self.assertEqual(l_obj.UserName, TESTING_BROKER_USERNAME)
        self.assertEqual(l_obj.Password, TESTING_BROKER_PASSWORD)
    ...
    def test_02_Mqtt(self):
        ...
        self.assertEqual(l_obj[1].UserName, TESTING_BROKER_USERNAME)
        self.assertEqual(l_obj[1].Password, TESTING_BROKER_PASSWORD)
...
class C1_Write(SetupMixin, unittest.TestCase):
    ...
    def test_01_Broker(self):
        ...
        self.assertEqual(l_xml.find('BrokerUser').text, TESTING_BROKER_USERNAME)
        self.assertEqual(l_xml.find('BrokerPassword').text, TESTING_BROKER_PASSWORD)
    ...
    def test_02_Mqtt(self):
        ...
        self.assertEqual(l_xml1.find('BrokerUser').text, TESTING_BROKER_USERNAME)
        self.assertEqual(l_xml1.find('BrokerPassword').text, TESTING_BROKER_PASSWORD)
        #
        l_xml2 = l_xml[1]
        ...
        self.assertEqual(l_xml2.find('BrokerUser').text, TESTING_BROKER_USERNAME)
        self.assertEqual(l_xml2.find('BrokerPassword').text, TESTING_BROKER_PASSWORD)
