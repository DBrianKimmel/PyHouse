...
TESTING_LIGHT_UUID_0 = '515Light-0000-11e6-0000-Light8b6eb6f'
TESTING_LIGHT_COMMENT_0 = "SwitchLink On/Off"
TESTING_LIGHT_CUR_LEVEL_0 = "42"
TESTING_LIGHT_DEVICE_FAMILY_0 = 'Insteon'
TESTING_LIGHT_DEVICE_TYPE_0 = '18'
TESTING_LIGHT_DEVICE_SUBTYPE_0 = '23'
TESTING_LIGHT_IS_DIMMABLE_0 = 'True'
TESTING_LIGHT_ROOM_X = '3.4'
TESTING_LIGHT_ROOM_Y = '5.6'
TESTING_LIGHT_ROOM_Z = '1.2'
TESTING_LIGHT_ROOM_COORDS = '[' + TESTING_LIGHT_ROOM_X + ', ' + TESTING_LIGHT_ROOM_Y + ', ' + TESTING_LIGHT_ROOM_Z + ']'
TESTING_LIGHT_COORDS_0 = "['0', '0', '0']"
TESTING_LIGHT_ROOM_0 = "Master Bath"
...
L_LIGHT_ROOM_NAME_0 = '    <RoomName>' + TESTING_LIGHT_ROOM_0 + '</RoomName>'

L_LIGHT_DIMMABLE_0 = '    <IsDimmable>' + TESTING_LIGHT_IS_DIMMABLE_0 + '</IsDimmable>'
...
TESTING_LIGHT_UUID_1 = '515Light-0001-11e6-0001-Light8b6eb6f'
