...
class SetupMixin(object):
    ...
    def setUp(self, p_root):
        ...
        self.m_family = family.API(self.m_pyhouse_obj)._init_component_apis(self.m_pyhouse_obj)
...
class C1_Read(SetupMixin, unittest.TestCase):
    ...
    def test_01_Core(self):
        l_core = self.m_api.read_core_lighting_xml(self.m_light_obj, self.m_xml.light)
    ...
    def test_01_BaseLight(self):
        """ Read in the xml file and fill in the lights
        """
        l_base = self.m_api.read_core_lighting_xml(self.m_light_obj, self.m_xml.light, 1.4)
