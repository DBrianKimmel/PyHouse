...
TESTING_LIGHT_ROOM_COORDS_0 = '[' + \
            TESTING_LIGHT_ROOM_X + ',' + TESTING_LIGHT_ROOM_Y + ',' + TESTING_LIGHT_ROOM_Z + ']'
...
TESTING_LIGHT_COMMENT_1 = "SwitchLink Dimmer Light Comment"
...
TESTING_LIGHT_ROOM_Z_1 = '7.89'
# TESTING_LIGHT_ROOM_COORDS = '[' + TESTING_LIGHT_ROOM_X + ', ' + TESTING_LIGHT_ROOM_Y + ', ' + TESTING_LIGHT_ROOM_Z + ']'
TESTING_LIGHT_ROOM_COORDS_1 = '[1.23,4.56,7.89]'
TESTING_LIGHT_ROOM_NAME_1 = 'Master Bath'
TESTING_LIGHT_ROOM_UUID_1 = 'Light...-Room-0000-0000-Room.8b6eb6f'
