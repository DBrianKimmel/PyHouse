...
TESTING_HVAC_THERMOSTAT_COMMENT_0 = 'Comment zero'
TESTING_THERMOSTAT_DEVICE_FAMILY_0 = 'Insteon'
TESTING_THERMOSTAT_DEVICE_SUB_TYPE_0 = '1'
TESTING_THERMOSTAT_DEVICE_TYPE_0 = '2'
...
L_THERMOSTAT_DEVICE_FAMILY_0 = '            <DeviceFamily>' + TESTING_THERMOSTAT_DEVICE_FAMILY_0 + '</DeviceFamily>'
L_THERMOSTAT_DEVICE_SUB_TYPE_0 = '            <DeviceSubType>' + TESTING_THERMOSTAT_DEVICE_SUB_TYPE_0 + '</DeviceSubType>'
L_THERMOSTAT_DEVICE_TYPE_0 = '            <DeviceType>' + TESTING_THERMOSTAT_DEVICE_TYPE_0 + '</DeviceType>'
