...
class DecodeResponses(object):
    ...
    def decode_50(self, p_pyhouse_obj, p_device_obj, p_controller_obj):
        ...
        elif l_cmd1 == 0x72:  #  Status Report Heat Set Point
