...
class Test(unittest.TestCase):
    ...
    def test_001_get_message_length(self):
        self.assertEqual(self.api._get_message_length(MSG_50), 11)
        self.assertEqual(self.api._get_message_length(MSG_62), 9)
        self.assertEqual(self.api._get_message_length(MSG_99), 1)
