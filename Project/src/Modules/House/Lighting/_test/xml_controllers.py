"""
@name:      PyHouse/src/Modules/Lighting/_test/xml_controllers.py
...
TESTING_CONTROLLER_TYPE_0 = 'Lighting'
TESTING_CONTROLLER_SUBTYPE_0 = 'Controller'
...
TESTING_CONTROLLER_TYPE = 'Lighting'
TESTING_CONTROLLER_SUBTYPE = 'Controller'
