...
class XML:
    ...
    def _active_section(self, p_plugin_data, p_pyhouse_obj):
    ...
    def read_entertainment_subsection(self, p_xml):
    ...
    def read_entertainment_all(self, p_pyhouse_obj, p_xml):
        ...
        l_count = 0
        for l_xml in p_xml:
            l_sub = self.read_entertainment_subsection(l_xml)
