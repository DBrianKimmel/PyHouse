...
L_ONKYO_SECTION_TYPE = '<Type>' + TESTING_ONKYO_TYPE + '</Type>'
...
TESTING_ONKYO_DEVICE_VOLUME_0 = '42'
...
L_ONKYO_VOLUME_0 = '<Volume>' + TESTING_ONKYO_DEVICE_VOLUME_0 + '</Volume>'
...
TESTING_ONKYO_DEVICE_VOLUME_1 = '24'
...
L_ONKYO_VOLUME_1 = '<Volume>' + TESTING_ONKYO_DEVICE_VOLUME_1 + '</Volume>'
