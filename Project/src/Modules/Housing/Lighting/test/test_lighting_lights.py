"""
@name:      Modules/Housing/Lighting/test/test_lighting_lights.py
...
from Modules.Core.Utilities.config_tools import \
    Yaml as configYaml
from Modules.Housing.Lighting.lighting_lights import Config as lightsConfig
...
class C1_YamlRead(SetupMixin, unittest.TestCase):
    ...
    def test_05_Light(self):
        ...
        self.assertEqual(l_obj.Comment, 'This is test light 1')
