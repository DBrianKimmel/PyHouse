"""
@name:      PyHouse/src/_test/test_xml_data.py
...
This _test should always be run as the very first _test.
...
class A1_Raw(unittest.TestCase):
    """
    This section will verify the XML in the 'Modules._test.xml_data' file is correct and what the log module can read/write.
    """
